...
const initiallyDisplayedCurrencies = ["EUR","USD","GBP", "JPY", "RUB"];
let baseCurrency;
let baseCurrencyAmount;
//Currencies List
const dataURL="http://api.exchangeratesapi.io/v1/latest?access_key=08180c4ba560990004e8dfc144972726";
let currencies = [
    {
        name: "US Dollar",
        abbreviation: "USD",
